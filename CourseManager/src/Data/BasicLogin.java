...
public class BasicLogin {
	...
	public String filePath = "CourseManager/data/Login.txt";
	...
	/**
	 * Updates the Login.txt file with current encrypted user and pass Strings
	 */
	public void updateFile() {
        try{
            PrintWriter outputStream = new PrintWriter(new FileOutputStream(filePath , false));
